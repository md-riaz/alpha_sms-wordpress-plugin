    ...
    <form method="post" name="<?php echo $this->plugin_name; ?>" action="options.php"
        ...
        <table class="form-table" aria-label="admin settings form">
            <tr>
                ...
                <td>
                    <input id="<?php echo $this->plugin_name; ?>-api_key"
                           name="<?php echo $this->plugin_name; ?>[api_key]"
                           type="text" size="55"
                           placeholder="Enter API Key"
                           value="<?php if (!empty($api_key)) {
                               echo $api_key;
                           } ?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input id="<?php echo $this->plugin_name; ?>-sender_id"
        ...
        <ol class="switches">
            <li>
                ...
                <label for="<?php echo $this->plugin_name; ?>-wp_reg">
                    ...
                    <span><?php esc_attr_e('Two Factor OTP Verification For WordPress Register Form',
            ...
            <li>
                ...
                <label for="<?php echo $this->plugin_name; ?>-wp_login">
                    <span class="toggle_btn"></span>
                    <span><?php esc_attr_e('Two Factor OTP Verification For WordPress Login Form',
                            $this->plugin_name); ?></span>
                </label>
            </li>
