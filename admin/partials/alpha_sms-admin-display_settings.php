...
<div class="wrap">
  ...
  <form method="post" name="<?php echo $this->plugin_name; ?>" action="options.php"
    ...
    } else if ($response && $response->error === 405) {
    ...
    <table class="form-table" aria-label="admin settings form">
      <tr>
        ...
        <td>
          <input id="<?php echo $this->plugin_name; ?>-api_key" name="<?php echo $this->plugin_name; ?>[api_key]"
            type="text" size="55"
            value="<?php if (!empty($api_key)) echo $api_key; else echo 'Enter Your API Key'; ?>" />
        </td>
      </tr>
      ...
      <tr>
        <th scope="row">
          <label for="<?php echo $this->plugin_name; ?>-balance">

          </label>
        </th>
        <td>
          <span id="<?php echo $this->plugin_name; ?>-balance">
    ...
    <ol class="switches">
      ...
      <li>
        <div class="toggle_container">
          ...
          <span class="toggle_visible"
            data-visible="order_status_buyer"><?php esc_attr_e('Notify Customer on Order Status Change', $this->plugin_name); ?></span>
        </div>
        <div id="order_status_buyer">
          ...
          <fieldset class="notify_template">
            ...
            <textarea id="<?php echo $this->plugin_name; ?>-buyer_status_sms"
              name="<?php echo $this->plugin_name; ?>[BUYER_STATUS_SMS]" rows="4" cols="85"><?php echo $buyer_status_sms; ?>
            </textarea>
          </fieldset>
      ...
      <li>
        <div class="toggle_container">
          ...
          <span class="toggle_visible"
            data-visible="order_status_admin"><?php esc_attr_e('Notify Admin on New Order', $this->plugin_name); ?></span>
        </div>
        <div id="order_status_admin">
          <fieldset class="notify_template">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="<?php echo $this->plugin_name; ?>-admin_phones">
                                <?php esc_attr_e('Admin Phone Numbers', $this->plugin_name); ?>
                            </label>
                        </th>
                        <td>
                            <input id="<?php echo $this->plugin_name; ?>-admin_phones" name="<?php echo $this->plugin_name; ?>[admin_phones]"
                                   type="text" size="47"
            ...
            <textarea id="<?php echo $this->plugin_name; ?>-admin_status_sms"
              name="<?php echo $this->plugin_name; ?>[ADMIN_STATUS_SMS]" rows="4" cols="85"><?php echo $admin_status_sms; ?>
            </textarea>
          </fieldset>
